...
# 适配版本（2026-09-09 / app.asar = 1463506265；游戏再次更新后改这里 4 个数字即可）
$EXPECTED_ASAR = 1463506265   # 原版 app.asar 字节数
$EXPECTED_TE   = 249006       # TowerExploration-*.js 原版字节数
$EXPECTED_IDX  = 2068393      # index-*.js 原版字节数
$EXPECTED_AC   = 4010164      # AppContent-*.js 原版字节数
