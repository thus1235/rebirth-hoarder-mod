...
const jeTo = 'Dt=i.useMemo(()=>{if(Je)return ua;const n=o.exploration?.towerChapterProgress?.[t],f=(r.rhMod?.towerAllFloorsUnlocked&&(t||"").startsWith("ruin_"))?(ar(t)?.endFloor||0):0;return Math.max(f,n?.bestLocalFloor??0)},[Je,t,o.exploration,r.rhMod]),';
{
